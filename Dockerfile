...
ENV KUBECTL_VERSION 1.20.0-alpha.2
ENV KUBECTL_URL https://storage.googleapis.com/kubernetes-release/release/v$KUBECTL_VERSION/bin/linux/amd64
ENV KUBECTL_FILENAME kubectl
ENV KUBECTL_SHA256 6847652ce5ae6d8e2c68fa767db01cdf1975a95c9fd2d6e50f2813b166e75161
...
# From https://www.terraform.io/downloads.html
ENV TERRAFORM_LATEST_VERSION 0.13.4
...
ENV TERRAFORM_LATEST_SHA256 a92df4a151d390144040de5d18351301e597d3fae3679a814ea57554f6aa9b24
...
# From https://github.com/gruntwork-io/terragrunt/releases
ENV TERRAGRUNT_NEW_VERSION 0.25.3
...
ENV TERRAGRUNT_NEW_SHA256 32e21f061c6e292a7c09431a3b38489b17e02689606e3f1f14b7df11b727f35a
...
ENV PACKER_SHA256 a20ec68e9eb6e1d6016481003f705babbecc28e234f8434f3a35f675cb200ea8
...
ENV EKSCTL_SHA256 4cc9eb5615d2755c15400f8dafc72c6f44acf9d7ebf8e9b96c434ed79da75d04
...
ENV AWS_OKTA_VERSION 1.0.5
ENV AWS_OKTA_URL https://github.com/segmentio/aws-okta/archive
ENV AWS_OKTA_FILENAME v${AWS_OKTA_VERSION}.tar.gz
ENV AWS_OKTA_SHA256 ab9e34d8d32b76c29699edd375ec3b99ce87d2fd4b0020235d49a2c0840937a3
